...
def instruction():
    return (
        ...
        "🤖 МЕТРО — Аналитик\n"
        f"🏪 {BRANCH_NAME}\n\n"
        "📊 Сегодня — выручка, клиенты, визиты и средний чек.\n"
        "👨‍💼 Мастера — показатели и сравнение мастеров.\n"
        "📈 Динамика — сравнение периодов, выбор дат через календарь.\n"
        "👥 Клиенты — база, уходящие и потерянные клиенты.\n"
        "💰 Финансы — основные финансовые показатели.\n"
        "💈 Услуги — количество и выручка по услугам.\n"
        "📣 Маркетинг — источники клиентов.\n"
        "🎯 План / факт — месячный план, факт, выполнение и остаток.\n\n"
        "🤖 Спроси аналитика — задавай вопросы обычным языком.\n"
        "ИИ анализирует данные МЕТРО из YCLIENTS, объясняет причины, сравнивает показатели и предлагает решения.\n\n"
        "ℹ️ Выбирай нужный раздел в главном меню."
    )
