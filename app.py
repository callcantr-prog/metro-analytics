...
def ask_groq(question, history=None):
    ...
    try:
        ...
        try:
            ...
            print("Analytics context error:", repr(exc))
        ...
        if response.status_code != 200:
            print("Groq HTTP error:", response.status_code, response.text[:2000])
        ...
        if response.status_code != 200:
            print("Groq final HTTP error:", response.status_code, response.text[:2000])
            return (
        ...
        if not answer:
            print("Groq empty response:", data)
        ...
        print("Groq request error:", repr(exc))
